...
"""
graph/neo4j_client.py — DeepChain Hybrid-RAG

No logic changes from original. Included here for completeness.
Reads NEO4J_URI, NEO4J_USERNAME, NEO4J_PASSWORD from .env via python-dotenv.
"""
...
class Neo4jClient:
    ...
    def reset_db(self) -> None:
        """Clears the entire database. Development only — use with caution."""
        print("[!] Resetting Neo4j Database...")
        self.query("MATCH (n) DETACH DELETE n")
